...
{
    ui->setupUi(this);
    EditableLabel::select = qobject_cast<EditableLabel*>(ui->expression->layout->itemAtPosition(1,1)->widget());
    ...
    connect(ui->pushButton_0, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_1, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_2, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_3, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_4, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_5, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_6, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_7, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_8, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_9, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_dot, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_add, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_sub, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_mul, &QPushButton::clicked, this, &MainWindow::addSymbol);
    connect(ui->pushButton_div, &QPushButton::clicked, this, &MainWindow::addSymbol);

    connect(ui->pushButton_del, &QPushButton::clicked, this, &MainWindow::delSymbol);

    connect(ui->pushButton_latex, &QPushButton::clicked, this, &MainWindow::makeLatex);
...
void MainWindow::addSymbol() {
    ...
    EditableLabel::select->setText(EditableLabel::select->text() + button->text());
}
